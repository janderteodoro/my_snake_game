...
def game_loop():
    ...
    while not game_over:
        ...
        while game_close == True:
            ...
            press_msg = font_style.render('Pressione:', True, white)
            quit_message = font_style.render('Q para sair', True, white)
            restart_message = font_style.render('C Para jogar novamente', True, white)
